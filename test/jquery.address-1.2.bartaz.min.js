...
a;ca=j}if(!P&&aa)d.replace(d.href.indexOf("#")!=-1?d.href:d.href+"#");P=j},50);return this}return l.title},value:function(a){if(arguments.length>1)return this.value(arguments[0]+(arguments[1]?"?"+arguments[1]:"")+(arguments[2]?"#"+arguments[2]:""));if(a!==undefined){a=T(I(V(a,e)));if(a=="/")a="";if(f==a&&!M)return;P=e;f=a;if(i.autoUpdate||M){K=e;F(e);w[E.length]=f;if(B)if(i.history){d[q][d.pathname]=w.toString();C=E.length+1;if(m<418){if(d.search==""){N.action="#"+t(f,e);N.submit()}}else if(m<523||
f==""){var b=l.createEvent("MouseEvents");b.initEvent("click",e,e);var g=l.createElement("a");g.href="#"+t(f,e);g.dispatchEvent(b)}else d.hash="#"+t(f,e)}else d.replace("#"+t(f,e));else if(f!=s())if(i.history)d.hash="#"+J(t(f,e),e);else d.replace("#"+t(f,e));u&&m<8&&i.history&&D(Y,50);if(B)D(function(){K=j},1);else K=j}return this}if(!O)return null;return I(V(J(f,j),j))},path:function(a){if(a!==undefined){this.value(a,this.queryString(),this.fragment());return this}a=this.value();return a.indexOf("?")!=
